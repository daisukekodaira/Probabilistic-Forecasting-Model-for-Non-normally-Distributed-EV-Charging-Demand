function kmeansEV_Training(LongTermpastData, path)
    ...
    PastPredictors= train_data(:,2:11); % Extract predictors (Year,Month,Day,Hour,Quater,P1(Day),P2(Holiday),P3(HighestTemp),P4(weather))
    pastEnegyTrans = train_data(:, 12); % 12 : Charge/Discharge [kwh]
    pastSOC = train_data(:,13); % 13: SOC[%]
